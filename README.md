...
git clone https://github.com/Mi9chada-CTF-Team/training.git
...
4. Join weekly practice sessions (announced via UM6P ACM channels)
5. Compete in beginner-friendly CTFs (picoCTF, TryHackMe, Hack The Box)
...
- Regional competitions (Africa, MENA)
- National events (Morocco Cybersecurity Week, IDEH)
- University-hosted CTFs (UofTCTF, LA CTF, PascalCTF)

*Track our schedule: [CTFtime Calendar](https://ctftime.org/team/418761)*
...
See [CONTRIBUTING.md](CONTRIBUTING.md) for style guidelines and review process.
...
Unless otherwise specified, all content is licensed under the [MIT License](LICENSE).
